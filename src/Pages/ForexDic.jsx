...
const ForexDictionary = () => {
  ...
  return (
    <div className="container mt-4">
      <h1 className="text-center mb-4">Forex Dictionary</h1>
      <p className="text-center mb-4">
        Forex trading has many benefits, no doubt about it, but it doesn't make
        it any less confusing for people who are just getting started in the
        currency market. This is a comprehensive dictionary of forex words that
        offers essential meanings most simply.
      </p>
          ...
          <React.Fragment key={letter}>
            ...
            {terms.map((termObj, index) => (
              <Card key={`${letter}-${index}`}>
                ...
                >
                  <h5 className="mb-0">{termObj.term}</h5>
                </Accordion.Toggle>
                <Accordion.Collapse eventKey={`${letter}-${index}`}>
                  <Card.Body>
