  ...
  const benefits = [
    {
      ...
      description: "$10 Low entry requirement",
      icon: <DepositIcon />,
    },
    {
      title: "Minimum Withdrawals",
      description: "$10 Flexible withdrawal options",
      icon: <WithdrawalIcon />,
    },
    {
      title: "Instruments",
      description: "50+ Access to a wide range of trading instruments",
      icon: <InstrumentsIcon />,
    },
    {
      title: "Leverage",
      description: "Starting from 1:1000",
      icon: (
    ...
    },
    {
      ...
      description: "Feel Free, Trade Free",
      icon: (
    ...
    {
      title: "Spreads",
      description: "Competitive spreads starting from as low as 0.1",
      icon: (
    ...
    >
      <div className="container">
        ...
        >
          ...
          <motion.h3 className={styles.sectionSubtitle} variants={item}>
