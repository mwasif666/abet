  ...
  const benefits = [
    {
      ...
      description:
        "Access to over 50 currency pairs, including majors, crosses, and exotics.",
      icon: <DepositIcon />,
    },
    {
      title: "Minimum Withdrawals",
      description: "Available five days a week, 24 hours a day.",
      icon: <WithdrawalIcon />,
    },
    {
      title: "Instruments",
      description: "Leverage up to 1:1000.",
