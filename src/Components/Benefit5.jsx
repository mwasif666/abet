  ...
  const benefits = [
    {
      ...
      description: "Accessible 7 days a week, 24 hours a day",
      icon: <DepositIcon />,
    },
    {
      title: "Minimum Withdrawals",
      description: "Zero commissions on all trades",
      icon: <WithdrawalIcon />,
    },
    {
      title: "Instruments",
      description: "Leverage up to 1:500",
      icon: <InstrumentsIcon />,
    },
    {
      title: "Leverage",
      description: "Option to go long or short based on market movements",
      icon: (
    ...
    },
    {
      ...
      description: "An attractive alternative investment option besides Forex",
      icon: (
    ...
    {
      title: "Spreads",
      description: "Tight spreads with no re-quotes",
      icon: (
