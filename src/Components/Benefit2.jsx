  ...
  const benefits = [
    {
      ...
      description: "Easy and affordable access to the globe's equity markets",
      icon: <DepositIcon />,
    },
    {
      title: "Minimum Withdrawals",
      description: "Fast access to global economies",
      icon: <WithdrawalIcon />,
    },
    {
      title: "Instruments",
      description: "Conjecture regarding upward and downward market trends",
      icon: <InstrumentsIcon />,
    },
    {
      title: "Leverage",
      description: "Trade with a 1:500 leverage ratio",
      icon: (
    ...
    },
    {
      ...
      description: "Diversification of portfolios",
      icon: (
    ...
    {
      title: "Spreads",
      description: "There are no extra fees",
      icon: (
