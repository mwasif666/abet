...
import RawSpreadTable from "../Pages/account-types/PriceSection";
import Phone from "../assets/phone.png";

const RawSpreadAccount = () => {
  return (
              ...
              <Navbar className={styles.navbar}>
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                  <Nav className={`mx-auto ${styles.navMenu}`}>
                    <Nav.Link
                      href="https://abet.leosagitrades.com/account-types/micro/"
                      className={styles.navLink}
                    >
                      Micro
                    </Nav.Link>
                    <Nav.Link
                      href="https://abet.leosagitrades.com/account-types/raw-spread/"
...
export default RawSpreadAccount;
