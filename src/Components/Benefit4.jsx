  ...
  const benefits = [
    {
      ...
      description: "Trade gold and silver online without requotes",
      icon: <DepositIcon />,
    },
    {
      title: "Minimum Withdrawals",
      description: "A strong alternative investment alongside Forex",
      icon: <WithdrawalIcon />,
    },
    {
      title: "Instruments",
      description: "No swap fees on any accounts",
      icon: <InstrumentsIcon />,
    },
    {
      title: "Leverage",
      description:
        "Flexible trading with the ability to go short or long from a single account",
      icon: (
    ...
    },
    {
      ...
      description: "Leverage options up to 1:1000",
      icon: (
    ...
    {
      title: "Spreads",
      description: "Trade with no additional fees",
      icon: (
